<?php
	...
	$data = array(
		...
		':bio' => $bio, 
		':gender' => $gender,
		':enable_sounds' => (int)(bool)$enable_sounds,
		':enable_styles' => (int)(bool)$enable_styles,
		':message_font_size' => (int)$message_font_size,
		':message_font_color' => $message_font_color,
		':message_font_face' => $message_font_face,
		':use_default_timestamp_settings' => (int)$use_default_timestamp_settings,
		':enable_timestamps' => (int)$enable_timestamps,
		':ts_24_hour' => (int)$ts_24_hour,
		':ts_show_seconds' => (int)$ts_show_seconds,
		':ts_show_ampm' => (int)$ts_show_ampm,
		':ts_show_date' => (int)$ts_show_date,
	);
