<?php $display('layout/header'); ?>
	...
	<div id="content_area">
		<div id="content_title_bar">
			<div id="title"></div>
			<div id="close"><a href="#"><?php $lang('close_content_button'); ?></a></div>
	...
	<div id="chat_area">
		<div id="active_rooms_area">
			...
			<ul data-bind="foreach: rooms">
				<li><a href="#" data-bind="text: name, click: $root.set_active_room"></a> <span data-bind="if: type == 'user'" class="private_chat_text">(private)</span> - <a href="#" data-bind="click: $root.leave_room"><?php $lang('leave_room'); ?></a></li>
			</ul>
			<br />
		...
		<div id="room_tab_bar">
			...
			<div id="room_tabs_button">
				<a href="#" data-bind="click: show_rooms"><?php $lang('all_rooms'); ?></a> (<span data-bind="text: room_count()"></span>)
			</div>
			<div id="alert_rooms">
				<ul data-bind="foreach: rooms">
					<!-- ko if: alert -->
						<li data-bind="click: $root.set_active_room"><a href="#" data-bind="text: name"></a> <span data-bind="if: type == 'user'" class="private_chat_text"> - private</span> (<span data-bind="text: alert"></span>)</li>
					<!-- /ko -->
				</ul>
			</div>
			<div style="clear: both;"></div>
