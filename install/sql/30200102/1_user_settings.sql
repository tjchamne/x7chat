...
ALTER TABLE `{$prefix}users` ADD `use_default_timestamp_settings` BOOL NOT NULL DEFAULT '1',
...
ADD `message_font_size` TINYINT UNSIGNED NOT NULL ,
ADD `message_font_color` CHAR( 6 ) NOT NULL ,
ADD `message_font_face` BIGINT UNSIGNED NOT NULL;